...
export class CreateOrderDto {
  ...
  @IsString({
    message: 'La dirección de facturación debe ser una cadena de texto',
  })
  ...
  @IsEnum(PaymentMethod, {
    message:
      'El método de pago debe ser TARJETA, TRANSFERENCIA o CONTRA_ENTREGA',
  })
  ...
  @ApiProperty({
    description: 'Teléfono de la transportadora',
    example: '018000123456',
  })
  @IsString({
    message: 'El teléfono de la transportadora debe ser una cadena de texto',
  })
